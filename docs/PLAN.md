...
- El RSVP personalizado se presenta junto al nombre invitado: muestra el pase total, un contador de 0 al límite y un resultado explícito. Cero requiere confirmación adicional antes de registrar declinación; cualquier valor superior confirma asistencia con un botón descriptivo y una notificación verde del resultado.
- Los formularios administrativos de creación y edición usan lenguaje de persona o familia y un cupo total de pase; ya no solicitan una lista de nombres ni un invitado principal.
- El listado administrativo usa los mismos términos: muestra persona o familia y el pase total de personas, en vez de nombres múltiples o “extras”.
...
- Añadidas animaciones fluidas de entrada para textos, flores, sello, fecha, ubicaciones, vestimenta y rosa decorativa al hacer scroll. Los fondos permanecen estáticos para preservar la composición; las transiciones usan Motion for React y respetan la preferencia global de movimiento reducido.
- Rediseñada la experiencia previa a la invitación personalizada: el loading adopta la paleta crema, rosa, dorada y verde de la landing y comunica explícitamente la carga; el sobre se compone de los assets `sobre.png`, `pestanaSobre.png` y un sello centrado en la punta de la pestaña. Durante la apertura, el cuerpo y la pestaña se desplazan ligeramente uno hacia el otro para que la propia textura de las imágenes cubra el borde transparente sin separaciones visibles. La invitación permanece oculta hasta iniciar, muestra completa y en mayor tamaño la imagen vertical `invitacion.jpeg`, y se conserva visible unos segundos antes de continuar a la landing.
