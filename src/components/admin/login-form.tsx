...
export function LoginForm() {
  ...
  return (
    <main className='grid min-h-screen place-items-center bg-cream px-5'>
      <section className='w-full max-w-md rounded-[2rem] border border-rose/30 bg-white p-8 shadow-sm'>
        <LockKeyhole className='text-gold' />
        <p className='mt-6 text-sm font-semibold tracking-[0.2em] text-gold'>ADMINISTRACIÓN</p>
        <h1 className='mt-2 font-serif text-3xl text-wine'>Bienvenida</h1>
        <p className='mt-3 text-sm leading-6 text-stone-500'>
          Ingresa con la cuenta administrativa autorizada.
        </p>
        <form
          ref={formRef}
        ...
        >
          ...
          <button
            disabled={pending}
            className='w-full rounded-xl bg-wine py-3 text-sm font-semibold text-white disabled:opacity-60'
          >
